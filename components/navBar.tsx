...
const NavBar = () => {
  ...
  const currentLocale = language === "en" ? "en" : "hi";
        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            <select
              ...
              className="bg-white/5 border border-white/20 text-white text-sm rounded-lg px-3 py-2 pr-8 appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-emerald-400/70 focus:border-emerald-400/70"
            >
              {languages.map((lang) => (
                <option
                  key={lang.code}
            ...
            <span className="pointer-events-none absolute inset-y-0 right-2 flex items-center text-white/60 text-xs">
              ▼
            </span>
          </div>
